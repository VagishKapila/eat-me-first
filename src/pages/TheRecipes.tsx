        ...
        <Reveal>
          <div className="mb-12">
            ...
            <p className="mt-4 text-[#3a3a3a] text-lg max-w-xl" style={{ fontFamily: 'var(--font-sans)' }}>
              The original recipes, as written.
            </p>
          </div>
        </Reveal>
        <Reveal delay={120}>
          <div className="space-y-5 text-[#3a3a3a] text-lg leading-relaxed" style={{ fontFamily: 'var(--font-sans)' }}>
            <p>
              These recipes are over 40 years old. We've scaled them up, kept the process, and not changed a single
              ingredient. They're not ours to change.
            </p>
            <p>Full recipe cards coming soon.</p>
          </div>
        </Reveal>
      </div>
    </main>
